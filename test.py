...
#---------------------------- Here, few parameters are extra here--------------------
...
#--------------------Here, few lines are not used. Bcz this model has used other technique to load dataset----------
def test(test_loader, network, result_dir):
    ...
    # ----------------------------------This is an Extra line here--------------------
    f_result.write('Avg_all,%.02f,%.03f\n' % (PSNR.avg, SSIM.avg))

    f_result.close()

    # ----------------------These lines are not included here here---------------------------
...
if __name__ == '__main__':
    ...
    #---------------------------This line is not included here-------------------------
    ...
    #--------------- DAta is loaded in different way, Therefore, dataset_dir is not included ----
    # load dataset
